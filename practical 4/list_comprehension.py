...
# TO: use a list comprehension to create a list of all of the full_names
# in lowercase format
lowercase_full_names = [name.lower() for name in names]
print(lowercase_full_names)

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
# T: use a list comprehension to create a list of integers
# from the above list of strings
numbers = [int(number) for number in almost_numbers]
print(numbers)

# TO: use a list comprehension to create a list of only the numbers that are
# greater than 9 from the numbers (not strings) you just created
number1 = [number for number in numbers if number > 9]
print(number1)
